...
public:
    Presidente(string nome, string partido, string numero, string p) : Politico{nome, partido, numero}, pais{p}
    {
...
public:
    Governador(string nome, string partido, string numero,
               string pais, string e) : Presidente{nome, partido, numero, pais},estado{e}
    {
